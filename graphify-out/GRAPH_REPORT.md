...
- 1461 nodes · 1712 edges · 107 communities (88 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `29870c07`
...
Cohesion: 0.25
Nodes (3): getConsumer(), getConsumer(), createConsumer()
...
Cohesion: 0.19
Nodes (6): liveCheck(), readyCheck(), AuthController, liveCheck(), readyCheck(), successResponse()
...
Cohesion: 0.06
Nodes (38): COOKIE_NAMES, gatewayAuthMiddleware(), optionalGatewayAuthMiddleware(), AccessTokenPayload, verifyAccessToken(), env, disconnectRedis(), globalForRedis (+30 more)
...
Cohesion: 0.13
Nodes (10): router, LoginRequestDto, LoginSchema, VerifyOtpRequestDto, VerifyOtpRequestSchema, RegisterSchema, authControllerPromise, router (+2 more)
...
Cohesion: 0.20
Nodes (5): startServer(), ERROR_CODES, ErrorCode, ERROR_MESSAGES, registerErrorMessages()
...
Cohesion: 0.25
Nodes (3): KafkaConsumerRunner, LoggerLike, MessageHandler
...
Cohesion: 0.33
Nodes (3): DLQ_REASONS, DlqReason, KAFKA_HEADERS
...
- **Why does `ERROR_CODES` connect `Community 84` to `Community 91`, `Community 85`?**
