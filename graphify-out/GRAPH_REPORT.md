...
## Corpus Check
- 226 files · ~50,576 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1463 nodes · 1684 edges · 109 communities (87 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e83fa0d`
...
Cohesion: 0.18
Nodes (8): shutdown(), startServer(), startServer(), resolveOtlpTracesUrl(), shutdownTelemetry(), startTelemetry(), TelemetryOptions, registerErrorMessages()
...
Cohesion: 0.20
Nodes (8): RegisterRequestDto, AUTH_DURATIONS, REDIS_KEYS, ERROR_CODES, AccessTokenPayload, RefreshTokenPayload, RegistrationSessionData, generateOtp()
...
## Knowledge Gaps
- **860 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+855 more)
...
- **Why does `@prisma/client` connect `Community 6` to `Community 1`?**
