...
- 165 files · ~30,767 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1086 nodes · 1254 edges · 81 communities (62 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `c0acbb43`
...
Cohesion: 0.11
Nodes (10): build(), getAuthController(), OtpEventPublisher, SCHEMA_VERSION, SCHEMA_VERSION, UserLoggedInEventPublisher, OtpEventPublisher, SCHEMA_VERSION (+2 more)
...
Cohesion: 0.09
Nodes (11): globalForPrisma, AuthMapper, UserMapper, PrismaClient, User, AuthRepository, OTPRequestedV1, OTPRequestedV1Type (+3 more)
...
Cohesion: 0.16
Nodes (18): errorResponse(), ApiError, createErrorResponse(), ErrorInput, ERROR_CODES, ErrorCode, ErrorContract, errorHandlerMiddleware() (+10 more)
...
Cohesion: 0.16
Nodes (9): startServer(), REDIS_KEYS, ERROR_CODES, ErrorCode, ERROR_MESSAGES, AccessTokenPayload, AuthUser, RegistrationSessionData (+1 more)
...
Cohesion: 0.31
Nodes (5): RegisterRequestDto, AUTH_DURATIONS, AccessTokenPayload, RefreshTokenPayload, generateOtp()
...
- **633 isolated node(s):** `AccessTokenPayload`, `RefreshTokenPayload`, `HealthChecks`, `Global Operations`, `Service-Specific Operations` (+628 more)
...
- **Why does `AuthController` connect `Health Check Endpoints` to `Community 79`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **What connects `AccessTokenPayload`, `RefreshTokenPayload`, `HealthChecks` to the rest of the system?**
